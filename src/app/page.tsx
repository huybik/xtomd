...
export default function Home() {
  ...
  const updateFile = useCallback(
    (id: string, updates: Partial<Omit<ProcessedFile, "id" | "file">>) => {
  ...
  const handleCopy = async (file: ProcessedFile) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Content of ${file.name} is now in your clipboard.`,
      });
  ...
  const handleCopyAll = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Content of all converted files is now in your clipboard.",
      });
    } catch (err) {
      toast({
        title: "Failed to copy",
